...
export default function About() {
  ...
  return (
    <div className="bg-brand-white min-h-screen">
      <section className="py-[140px] px-6 md:px-12 max-w-[1280px] mx-auto text-center border-b border-brand-border">
        <FadeIn>
           <p className="font-sans font-semibold text-[11px] uppercase tracking-[0.2em] text-brand-mid-grey mb-8">Who We Are</p>
           <h1 className="font-serif italic text-[40px] md:text-[80px] text-brand-black leading-tight max-w-[900px] mx-auto mb-16">
      ...
      {/* Stats Counter */}
      <section className="py-[140px] bg-brand-black px-6 md:px-12">
        <div className="max-w-[1280px] mx-auto text-center">
          <div className="grid md:grid-cols-3 gap-16">
             <FadeIn delay={0}>
               <div className="font-serif font-bold text-[72px] md:text-[96px] text-brand-white leading-none mb-4"><StatCounter end={150} suffix="+" /></div>
               <div className="font-sans font-semibold text-[13px] text-brand-mid-grey uppercase tracking-[0.15em]">Brands Transformed</div>
             </FadeIn>
             <FadeIn delay={0.1}>
               <div className="font-serif font-bold text-[72px] md:text-[96px] text-brand-white leading-none mb-4"><StatCounter end={98} suffix="%" /></div>
               <div className="font-sans font-semibold text-[13px] text-brand-mid-grey uppercase tracking-[0.15em]">Client Retention</div>
             </FadeIn>
             <FadeIn delay={0.2}>
               <div className="font-serif font-bold text-[72px] md:text-[96px] text-brand-white leading-none mb-4"><StatCounter end={10} suffix="M+" /></div>
      ...
      <section className="py-[140px] px-6 md:px-12 max-w-[1280px] mx-auto">
         <FadeIn>
           <h2 className="font-serif font-bold text-[48px] text-brand-black mb-16 text-center">Our Core Values.</h2>
         </FadeIn>
         <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="border border-brand-border rounded-[20px] p-[48px] h-full hover:shadow-[0_2px_20px_rgba(0,0,0,0.05)] transition-shadow">
      ...
      <section className="py-[140px] bg-brand-off-white px-6 md:px-12">
        <div className="max-w-[1280px] mx-auto">
          <FadeIn>
             <h2 className="font-serif font-bold text-[48px] text-brand-black mb-16 text-center">The Leadership.</h2>
          </FadeIn>
