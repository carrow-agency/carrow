  ...
  return (
    <section className="min-h-screen bg-brand-white flex flex-col justify-center items-center text-center pt-[72px] px-6 md:px-12">
      <div className="w-full max-w-4xl flex flex-col items-center justify-center py-20">
        ...
        <h1 className="font-serif font-bold text-[64px] md:text-[96px] lg:text-[112px] leading-[0.95] text-brand-black mb-8">
          <span className="block">We Build</span>
          <span className="block">Brands That</span>
          <span className="block">Stand Out.</span>
        </h1>
        <div className="font-sans text-[20px] md:text-[28px] text-brand-dark-grey leading-[1.6] max-w-[560px] mb-12">
        ...
        <div className="font-sans text-[13px] text-brand-mid-grey tracking-wide">
